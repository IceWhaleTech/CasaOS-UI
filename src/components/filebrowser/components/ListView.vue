...
<template>
  <div id="select-container" class="node-list fliebroswer is-flex is-flex-direction-column w-full scroll-container scrollbars-light ">
    <div class=" is-flex-grow-1 is-flex">
      <div
        class="is-relative is-grow-1 w-full" :class="containerHeight"
      ...
      >
        ...
        <div class="select-parent">
          ...
          <div class="table-thead is-unselectable">
            <div class="tr-wrapper">
              <div class="tr">
                <div class="th" />
                <div
                  v-for="header in headerList" v-if="isMobile ? header.showOnMobile : true" :key="header.text" class="th"
                ...
                >
                  ...
                  <b-icon
                    v-show="sort === header.sort" icon="expand-down" class="is-18 ml-1"
          ...
          <div class="tbody card-container">
            <div
              v-for="(item, index) in listData" :key="`list-${index}${item.name}`" :data-rel="index"
            ...
            >
              ...
              >
                <div class="td is-flex is-flex-direction-column justify-content-center">
                  ...
                  >
                    <b-checkbox
                      v-model="item.isSelected" size="is-small" class="mr-0"
                ...
                <div v-if="!isMobile" class="td">
                  <div v-show="!item.is_dir" class="one-line is-size-7">
                    {{ getFileExt(item) }}
                  </div>
                </div>
                <div v-if="!isMobile" class="td">
                  <div class="one-line is-size-7">
                    {{ item.date | dateFmt }}
                  </div>
                </div>
                <div v-if="!isMobile" class="td">
