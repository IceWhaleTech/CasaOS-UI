...
<template>
  <div :class="item | coverType">
    <transition name="fade">
      <img
        v-if="showThumb" key="thumb" :class="isWide ? 'thumb-w' : 'thumb-h'" :src="imageData" alt="folder"
        class="is-absolute"
      >
    ...
    <div class="overlay-layer">
      <b-icon
        v-if="isShared" class="share-icon casa-color-green casa-shape-rounded casa-shape-32px" custom-size="casa-28px"
        icon="share" pack="casa"
      />
    </div>
  </div>
</template>
