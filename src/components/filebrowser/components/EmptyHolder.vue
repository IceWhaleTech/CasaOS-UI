...
<template>
  <div class="has-text-centered">
    <h5 class="title is-65">
      {{ $t('Drop your files here to upload') }}
    </h5>
    <p class="is-size-7">
      {{ $t('or') }}
    </p>
    ...
    <ul class="is-flex upload-btns is-justify-content-center">
      <li class="e-btn" @click="$emit('newFile')">
        ...
        <b-image :src="require('@/assets/img/filebrowser/newFile.svg')" />
      </li>
      <li class="e-btn" @click="$emit('newFolder')">
        <span>{{ $t('New Folder') }}</span>
        <b-image :src="require('@/assets/img/filebrowser/newFolder.svg')" />
      </li>
      <li id="eUpFileBtn" class="e-btn">
        <span>{{ $t('Upload Files') }}</span>
        <b-image :src="require('@/assets/img/filebrowser/upfile.svg')" />
      </li>
      <li id="eUpFolderBtn" class="e-btn">
        <span>{{ $t('Upload Folder') }}</span>
        <b-image :src="require('@/assets/img/filebrowser/upfolder.svg')" />
      </li>
    </ul>
  </div>
</template>
