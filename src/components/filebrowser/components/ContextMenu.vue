...
<template>
  <div>
    <div :style="{ top: `${y}px`, left: `${x}px` }" class="action-btn context-menu">
      <b-dropdown
        id="dr1" ref="dropDown" :animation="ani" :close-on-click="false" :mobile-modal="false"
      ...
      >
        ...
        <template v-if="!showDetail">
          <b-dropdown-item
            key="system-context11" aria-role="menuitem" class="is-flex is-align-items-center"
          ...
          <b-dropdown-item
            key="system-context1" aria-role="menuitem" class="is-flex is-align-items-center"
          ...
          <b-dropdown-item
            id="upfileBtn" key="system-context2" aria-role="menuitem"
          ...
          <b-dropdown-item
            id="upfolderBtn" key="system-context3" aria-role="menuitem"
            class="is-flex is-align-items-center " @click="uploadFile"
          >
          ...
          <template v-if="hasPasteData">
            <b-dropdown-item
              key="system-context4" aria-role="menuitem" class="is-flex is-align-items-center"
              @click="paste('overwrite')"
            >
              <b-icon class="mr-1" custom-size="mdi-18px" icon="content-paste" />
              {{ $t('Paste - Overwrite') }}
            </b-dropdown-item>
            <b-dropdown-item
              key="system-context4-1" aria-role="menuitem" class="is-flex is-align-items-center"
              @click="paste('skip')"
            >
              <b-icon class="mr-1" custom-size="mdi-18px" icon="content-paste" />
              {{ $t('Paste - Skip') }}
          ...
          <hr class="dropdown-divider">
          <b-dropdown-item
            key="system-context5" aria-role="menuitem" class="is-flex is-align-items-center"
            @click="$refs.dropDown.toggle(); filePanel.reload()"
          >
            <b-icon class="mr-1" custom-size="mdi-18px" icon="refresh" />
            {{ $t('Refresh') }}
          </b-dropdown-item>
        </template>
        <!-- Blank End -->
        ...
        <template v-else>
          ...
          <hr class="dropdown-divider">
          <b-dropdown-item
            v-if="showSingleEdit && !isShared && !isMounted" key="file-context3"
            aria-role="menuitem" @click="rename"
          >
            {{ $t('Rename') }}
          </b-dropdown-item>
          <b-dropdown-item
            v-if="!isShared && !isMounted" key="file-context4" aria-role="menuitem"
          ...
          <b-dropdown-item
            v-if="showSingleEdit && isWallpaperType" aria-role="menuitem"
          ...
          <template v-if="!isShared && !isMounted">
            <hr class="dropdown-divider">
            <b-dropdown-item
              v-if="!isConfirmed" aria-role="menuitem" class="has-text-danger"
