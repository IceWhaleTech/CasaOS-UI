  ...
  <div class="overlay common-modal-background">
    <header class="modal-card-head">
      ...
      <div class="is-flex is-align-items-center">
        ...
        <b-button
          icon-left="downloads-outline" icon-pack="casa" type="is-primary" size="is-small"
    ...
    >
      <div v-if="poster !== ''" class="audio-blur-background" />
      <div class="video-container" :class="{ 'is-align-items-center': isAudio }">
        <div v-if="isVideo" key="video-player" ref="artRef" class="player" />
        <Aplayer
          v-if="isAudio" :key="item.path" :autoplay="true" preload="auto" class="player-audio"
          theme="#41b883" :music="{
            title: audioTitle,
            artist: audioArtist,
            src: getFileUrl(item),
