...
<template>
  <div class="modal-card">
      ...
      <div class="node-card">
        <div class="cover is-flex is-justify-content-center is-align-items-center">
          <div class="folder-cover">
            <img
              :src="require('@/assets/img/filebrowser/folder-default.svg')" alt="folder"
              class="folder-icon"
            >
          </div>
        </div>
        <b-field :message="errors" :type="errorType" class="mb-3 mt-5 has-text-light" expanded>
          <b-input
            ref="inputs" v-model="folderName" @keyup.enter.native="createFolder"
    ...
    <footer class="modal-card-foot is-flex is-align-items-center">
      ...
      <div>
        <b-button
          :label="$t('Submit')" :loading="isloading" expaned rounded type="is-primary"
          @click="createFolder"
        />
      </div>
    </footer>
