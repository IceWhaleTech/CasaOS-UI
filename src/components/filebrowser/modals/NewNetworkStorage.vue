...
<template>
  <div class="modal-card">
      ...
      <div class="node-card">
        <div>
          <b-field :label="$t('Server Address')">
            <b-autocomplete
              ref="inputs" v-model="host" :data="filteredDataObj"
          ...
          <div class="field is-flex ">
            ...
            <b-switch v-model="isGuest" type="is-dark" />
          </div>
    ...
    <footer class="modal-card-foot is-flex is-align-items-center">
      ...
      <div>
        <b-button
          :disabled="risk" :label="$t('Connect')" :loading="isConnecting" expaned rounded type="is-primary"
          @click="connect"
        />
      </div>
    </footer>
