...
<template>
	<div :status="status" class="uploader-file">
		<slot :average-speed="averageSpeed" :current-speed="currentSpeed" :error="error" :extension="extension" :file="file" :file-category="fileCategory"
		      :formated-average-speed="formatedAverageSpeed" :formated-size="formatedSize" :formated-time-remaining="formatedTimeRemaining"
