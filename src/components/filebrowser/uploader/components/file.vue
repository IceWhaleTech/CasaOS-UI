...
<template>
  <div :status="status" class="uploader-file">
    <slot
      :average-speed="averageSpeed" :current-speed="currentSpeed" :error="error" :extension="extension" :file="file"
    ...
    >
      <div class="task is-flex">
        <div
          v-if="status !== 'success'" :class="progressingClass" :style="progressStyle"
          class="task-progress normal"
        />
        <div class="task-info">
          <div class="cover">
        ...
        <div class="action">
          ...
          <span v-if="status === 'error'" class="action-icon icon" data-role="icon" @click="retry">
            <b-icon icon="replay" size="is-small" />
          </span>
