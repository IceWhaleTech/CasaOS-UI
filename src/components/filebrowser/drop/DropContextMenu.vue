...
<template>
  <div>
    <div :style="{ top: `${y}px`, left: `${x}px` }" class="drop-context-menu">
      <b-dropdown
        id="dr1" ref="dropDown" :animation="ani" :mobile-modal="false"
      ...
      >
        ...
        <b-dropdown-item key="drop-context1" aria-role="menuitem" class="is-flex is-align-items-center">
          <b-upload
            v-model="files" class="is-clickable has-text-full-03 is-flex is-align-items-center"
