    ...
    <section class="modal-card-body ">
      <div class="node-card">
        ...
        <b-field :label="$t('PC ( Windows explorer )')" class="mb-5" horizontal>
          <b-input
            :value="pcPath" expanded icon-pack="casa" icon-right="copy" icon-right-clickable name="subject"
            readonly @icon-right-click="copyToClipboard(pcPath)"
          />
        </b-field>
        <b-field :label="$t('Mac ( Finder )')" class="mb-5" horizontal>
          <b-input
            :value="macPath" expanded icon-pack="casa" icon-right="copy" icon-right-clickable name="subject"
            readonly @icon-right-click="copyToClipboard(macPath)"
          />
        </b-field>
      </div>
    </section>
