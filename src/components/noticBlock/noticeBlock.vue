    ...
    <div class="content widget _card is-flex is-flex-direction-column">
      ...
      >
        <div class="_widget-body is-flex mr-0">
          <div class="image is-24x24 is-flex-shrink-0">
            <img
              v-if="!noticeData.content[Object.keys(noticeData.content)[0]].icon"
        ...
        <div v-if="Object.keys(noticeData.content).length > 1" class="line _ml-2rem" />
        <div v-if="Object.keys(noticeData.content).length > 1" class="_widget-body is-flex mr-0">
          <div class="image is-24x24 is-flex-shrink-0">
            <img
              v-if="!noticeData.content[Object.keys(noticeData.content)[1]].icon"
              :src="require(`@/assets/img/logo/casa-white.svg`)" alt=""
            >
            <img
              v-else
      ...
      >
        <template v-if="noticeData.contentType !== 'progress'">
          <b-button
            v-if="!noticeData.operate" :disabled="false" class="width" rounded size="is-small"
            type="is-primary"
            @click="close"
          >
            {{ $t('Cancel') }}
          ...
          <b-button
            v-else-if="noticeData.operate.type === 'casaUI:eventBus'" :disabled="false" class="width"
            rounded
            size="is-small"
            type="is-primary"
            @click="eventBus"
        ...
        <div
          v-if="Object.keys(noticeData.content).length > 1 && noticeData.contentType === 'list'"
