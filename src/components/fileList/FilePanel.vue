    ...
    <section class="modal-card-body">
      <nav aria-label="breadcrumbs" class="breadcrumb ">
        <ul>
          ...
          <li v-if="showPopUp & showDots">
            <a @click="getParentList()">...</a>
          </li>
          <li class="is-active ">
            <div>{{ lastFolder }}</div>
          </li>
      ...
      <div class="file-list scrollbars-light">
        <ListItem
          v-for="(item) in fileList" :id="item.path" :key="item.path" :is-dir="item.is_dir" :item="item"
