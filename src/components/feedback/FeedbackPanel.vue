  ...
  <div class="modal-card">
    ...
    <section class="modal-card-body ">
      ...
      <div class="is-flex-grow-1 is-relative">
        <b-field :label="$t('Title')">
          <b-input
            v-model="postTitle" :placeholder="$t('Start with [Issue], [App Request], or [Feature Request]...')"
            maxlength="100"
          />
        </b-field>
        <b-field :label="$t('Description')">
          <b-input
            v-model="postBody" :placeholder="$t('The more details provided, the easier this feedback or issue gets addressed.')" maxlength="500"
            type="textarea"
          />
        </b-field>
        <b-field :label="$t('System infomation')">
          <div v-dompurify-html="markdownToHtml" class="feedback-info-container is-size-14px" />
        </b-field>
      </div>
    </section>
    ...
    <footer class="modal-card-foot is-flex is-align-items-center ">
      <div class="is-flex-grow-1">
        <a
          class="is-size-14px" rel="noopener"
          href="https://github.com/IceWhaleTech/CasaOS/issues/new/choose"
          target="_blank"
        >{{ $t('For more feedback options, visit CasaOS project on GitHub...') }}</a>
      </div>
      <div>
