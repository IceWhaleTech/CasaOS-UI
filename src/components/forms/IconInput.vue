...
<template>
  <b-input
    v-model="path" :placeholder="placeholder" expanded icon-right="image-filter-center-focus-strong"
    icon-right-clickable @input="handleInput" @icon-right-click="selectFile"
  />
</template>
