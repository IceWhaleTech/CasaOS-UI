  ...
  methods: {
    ...
    uninstallConfirm() {
      ...
      this.$buefy.dialog.confirm({
        ...
        message: this.$t(`Dta cannot be recovered after deletion! <br/>Continue on to uninstall this application?<br/>{divS}Delete userdata ( config folder ){divE}`, {
        ...
        onConfirm: () => {
          ...
          let checkDelConfig = document.getElementById("checkDelConfig") ? this.uninstallApp(document.getElementById("checkDelConfig").checked) : this.uninstallApp(false)
