      ...
      <section class="modal-card-body">
        ...
        <section v-if="currentSlide == 2" class="_b-line">
          <div class="installing-warpper mb-5">
            ...
            <h3 :class="currentInstallAppTextClass"
                class="title is-6 has-text-centered is-flex is-flex-direction-row is-align-items-center is-justify-content-center"
    ...
    qucikInstall(id) {
      ...
      this.$api.apps.getAppInfo(id).then(resp => {
        if (resp.data.success == 200) {
          ...
          this.initData.appstore_id = respData.appstore_id
