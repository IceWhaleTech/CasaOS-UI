...
<template>
  ...
  >
    <b-image
      :key="appDetailData.icon" :src="appDetailData.icon"
      :src-fallback="require('@/assets/img/app/default.svg')"
      class="is-64x64 icon-shadow" webp-fallback=".jpg"
    />
    <h2 class="has-text-emphasis-01 has-text-white mt-2">
      {{ appDetailData.name }}
    </h2>
    ...
    <b-image
      v-if="status === 'pending'" :src="require('@/assets/img/loading/waiting.svg')" alt="pending"
      class="is-48x48 mt-6"
    />
