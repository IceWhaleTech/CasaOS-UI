      ...
      <div class="widget-content">
        ...
        <div class="columns is-mobile is-multiline pt-2 ">
          <div class="column is-full pb-0">
            ...
            <b-progress
              :type="totalPercent | getProgressType" :value="totalPercent" class="mt-2"
              size="is-small"
            />
          </div>
        </div>
          ...
          <div v-for="(item) in usbDisks" :key="`usb_${item.name}`" class="column is-full pb-0">
            <div class="is-flex">
              <div class="header-icon is-flex-shrink-0">
                <b-image :src="require('@/assets/img/storage/USB.svg')" class="is-64x64" />
              </div>
              <div class="ml-2 is-flex-grow-1 ">
...
.tag {
  ...
  &.is-success {
    ...
    color: hsla(118, 70%, 45%, 1);
    border-color: hsla(118, 70%, 45%, 1);
  }
